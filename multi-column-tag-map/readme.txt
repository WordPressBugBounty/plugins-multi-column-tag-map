...
== Changelog ==
* v17.0.39 - sort_alpha sorting and title_divider_swap
* v17.0.38 - taxonomy sorting
...
* v17.0.33 - null
* v17.0.32 - $name_divider as an array and hiding empty child categories
* v17.0.31 - multiple custom post type fix part 2
* v17.0.30 - multiple custom post type fix
* v17.0.29 - post_tags conflict fix
* v17.0.28 - new query logic for categories and fixed sorting issue with name_divider in cunjunction with sort_alpha_groups
* v17.0.27 - security fix
* v17.0.26 - temp function error
* v17.0.25 - security patch
* v17.0.24 - jQuery update
* v17.0.23 - child_of bug
* v17.0.22 - responsive bug
* v17.0.21 - debugging
* v17.0.20 - Gutenberg
* v17.0.19 - add "from_category" support for pages
* v17.0.18 - added "multisite" option
* v17.0.17 - Multiple post types
* v17.0.16 - Legacy code fix and "child_of" with "taxonomy" now works
* v17.0.15 - Version Testing
